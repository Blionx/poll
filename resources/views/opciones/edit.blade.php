...
<div class="col-lg-12" style="align-items: center; display: flex;">
    <h1 class=" col-lg-10">Editar Opcion para el tipo de pregunta: {{$ty->nombre}}</h1>
    <a href="/opciones/{{$ty->id}}" class="btn btn-outline btn-primary pull-right"><i class="fa fa-chevron-left"> Regresar</i></a>
    <hr>
</div>
<div class="col-lg-12">
	<div class=" row well">
		<form method="post" action="{{action('OpcionesController@editor',array('tid'=>$ty->id,'id'=>$p->id))}}" enctype="multipart/form-data">
			<div class="col-md-12">
